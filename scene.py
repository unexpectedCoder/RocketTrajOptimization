...
class Scene2D:
    ...
    def __init__(self, xml_rocket: str, xml_traj: str):
        ...
        self.rocket = create_rocket(self.atmo, xml_rocket, xml_traj)
    ...
    def sim(self, xml_optim=None):
        ...
        if xml_optim is not None:
            self.rocket.optimize_traj(read_optim_xml(xml_optim))
        self.rocket.start()
...
def read_optim_xml(xml_path: str):
    """
    Reads optimizer's XML data file.
    :param xml_path: XML file's path
